...
void loop() {
  ...
  */
  ...
  // RIGHTMAT = ((1E-15*pow(RIGHT, 6))-(3E-12*pow(RIGHT, 5))+(4E-9*pow(RIGHT, 4))-(3E-6*pow(RIGHT, 3))+(0.0009*pow(RIGHT, 2))-(0.1874*RIGHT)+28.803);
  RIGHTMAT = (21 * log10((RIGHT*1.4)))- 61;
  int nsl = RIGHTMAT ;

  // RIGHTMAT =((2E-10*pow(RIGHT, 4)) - (4E-07*pow(RIGHT, 3)) + (0.0003*pow(RIGHT, 2)) - (0.1288*RIGHT) + (27.884));
  ...
  sprintf(stringbuffer, "Lev: %04i Input: %02i  Set: -%2i dBm " , nsl, portl, dBset );
